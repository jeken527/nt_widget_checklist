                                        ...
                                        <div className="frame-content-92_8517">
                                            ...
                                            >
                                                <div className="frame-content-92_8527">
                                                    ...
                                                    <div 
                                                        className="daily-planner-container"
                                                        style={{
                                                            width: "360px",
                                                            height: "360px", // 스크롤바가 생길 고정 영역
                                                            overflowY: "auto",
                                                            display: "flex",
                                                            flexDirection: "column",
                                                            gap: "6px",
                                                    ...
                                                    >
                                                        {props.dailyPlannerList && props.dailyPlannerList.map((plan, index) => (
                                                            // 👇 이것이 16번 반복해서 찍어낼 '단 1개의 붕어빵 틀' 입니다.
                                                            <div 
                                                                key={plan.hour} 
                                                                className="planner-row-dynamic"
                                                                style={{ display: "flex", alignItems: "center", width: "100%", height: "24px" }}
                                                            >
                                                                {/* (1) 시간 텍스트 (원본의 클래스 92_8538 유지하여 폰트 100% 동일) */}
                                                                <p className="Pixso-paragraph-92_8538" style={{ width: "30px", margin: 0, textAlign: "center", flexShrink: 0 }}>
                                                                    {plan.hour}
                                                                </p>

                                                                {/* (2) 점선/도트 (원본의 92_8539 클래스 재사용) */}
                                                                <div className="Pixso-vector-92_8539" style={{ position: "relative", top: 0, left: 0, width: "10px", height: "10px", margin: "0 8px", flexShrink: 0 }}></div>

                                                                {/* (3) 텍스트 입력창 (1번 상자에 다 적히던 오타 버그 완벽 해결!) */}
                                                                <input
                                                                    type="text"
                                                                    value={plan.text}
                                                                    onChange={(e) => props.updateDailyPlanner && props.updateDailyPlanner(index, e.target.value)}
                                                                    placeholder="TYPE HERE"
                                                                    className="Pixso-paragraph-92_8541"
                                                                    style={{
                                                                        flex: 1, height: "20px", border: "none", outline: "none", background: "transparent",
                                                                        fontFamily: "inherit", color: "inherit", padding: "0 10px", margin: 0, boxSizing: "border-box"
                                                                    }}
                                                                />

                                                                {/* (4) 체크박스 (유령 체크 버그 완벽 해결!) */}
                                                                <div 
                                                                    style={{ width: "24px", height: "24px", cursor: "pointer", display: "flex", justifyContent: "center", alignItems: "center", flexShrink: 0, marginLeft: "4px" }}
                                                                    onClick={() => props.togglePlannerCheck && props.togglePlannerCheck(index)}
                                                                >
                                                                    <div style={{ pointerEvents: "none" }}>
                                                                        <Checkbox checkbox_state={plan.checked ? "checked" : "default"} />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ))}
